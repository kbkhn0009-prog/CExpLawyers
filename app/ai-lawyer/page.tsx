    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto mb-8">
          ...
          <p className="text-lg text-[#8E8E8E] mb-4">
          ...
          <div className="glass border border-[#E31937]/20 rounded-none p-4">
            <p className="text-sm text-[#8E8E8E]">
              <strong className="text-white">Важно:</strong> AI не заменяет юриста, но экономит 80% времени на первичном этапе. 
